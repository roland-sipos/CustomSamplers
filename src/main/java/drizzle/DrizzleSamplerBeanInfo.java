...
public class DrizzleSamplerBeanInfo extends BeanInfoSupport {

	private static final Logger log = LoggingManager.getLoggerForClass();
	
	public DrizzleSamplerBeanInfo() {
		super(DrizzleSampler.class);
		
		createPropertyGroup("dizzle", new String[] {"database", "table"});

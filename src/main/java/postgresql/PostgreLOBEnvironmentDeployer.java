...
/**
 * This class is the extended EnvironmentDeployer for PostgreSQL, using the Large Object API.
 * */
class PostgreLOBEnvironmentDeployer extends EnvironmentDeployer {

	private Connection connection = null;
	private List<String> tagList;

	public PostgreLOBEnvironmentDeployer(String host, String port,

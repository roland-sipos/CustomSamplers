...
public class VoldemortConfigElementBeanInfo extends BeanInfoSupport {
	...
	public VoldemortConfigElementBeanInfo() {
		...
		createPropertyGroup("voldemort", new String[] {
	            "host", "port", "database", "store", "username", "password"});

		createPropertyGroup("options", new String[] {
				"maxThreads", "maxQueuedRequests", "maxConnectionsPerNode", "maxTotalConnections",
				"socketTimeout", "connectionTimeout", "routingTimeout", "socketBufferSize" 
		});

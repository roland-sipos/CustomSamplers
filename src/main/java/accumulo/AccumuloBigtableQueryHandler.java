...
public class AccumuloBigtableQueryHandler implements QueryHandler {

	private static Connector accumulo;

	public AccumuloBigtableQueryHandler(String cluster, Long buffSize, Long tOut, Integer nThreads)
